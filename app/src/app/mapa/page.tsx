...
import { Sparkles, RefreshCw, ChevronRight, ChevronLeft, AlertTriangle, Grid3X3, List } from "lucide-react";
                ...
                <div className="mt-6 max-w-xl mx-auto">
                  ...
                  <div className="flex items-center justify-between mt-6 gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1 px-4 py-3 rounded-2xl text-[11px] font-bold uppercase tracking-widest text-white bg-[var(--jesuites-blue)] shadow-lg hover:shadow-xl transition-all disabled:opacity-40"
                    >
    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-black/[0.04] transition-all hover:shadow-md">
      ...
      <div className="mb-4">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <button
            onClick={() => updateCourse(course.id, { student_access: true })}
          ...
          <div className="grid grid-cols-6 gap-1.5">
            {DELEG.map(dl => (
              <button
                ...
                className={`py-2.5 rounded-xl text-center transition-all ${d.delegation[dl.n] ? `${dl.color} text-white shadow-md ring-1 ring-black/10` : "bg-gray-100 text-gray-500 border border-gray-200 hover:bg-gray-200"}`}
              >
